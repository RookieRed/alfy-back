...
final class Version20180621100000 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, baccalaureate_id INT DEFAULT NULL, godfather_id INT DEFAULT NULL, user_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, salt VARCHAR(255) NOT NULL, birth_day DATETIME NOT NULL, roles JSON NOT NULL, INDEX IDX_8D93D649EACBD8D8 (baccalaureate_id), INDEX IDX_8D93D649FA632810 (godfather_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649FA632810 FOREIGN KEY (godfather_id) REFERENCES user (id)');
